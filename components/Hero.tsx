...
export default function Hero() {
  return (
    <section className="max-sm:mt-20 w-full flex flex-col justify-center items-center h-screen max-w-[1500px] xs:max-h-[450px] sm:max-h-[450px] md:max-h-[550px] lg:max-h-[700px] xl:max-h-[800px] bg-cover bg-right" style={{ backgroundImage: 'url("/assets/art.jpg")' }}>
